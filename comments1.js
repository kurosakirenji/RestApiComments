...
app.listen(
    PORT,
    () => console.log(`its now live for you on http://localhost:${PORT}`)
)

app.post('/comment1A?sort_by=desc(id)', (req, res)=> {
...
app.get('/comment1A?sort_by=desc(id)', (req, res)=> {
...
app('/comments1C').get(function(req,res){

    details.count( {id}, function(err, result){
